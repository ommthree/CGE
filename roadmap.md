...
- **Testing.** Every engine ships with: analytic tests on the toy economy (P0.5), at least one known-answer test against published numbers, and identity checks (IO balance, CGE homogeneity/Walras). These run in CI.
